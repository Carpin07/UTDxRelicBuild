...
const guideData = [
    ...
    { unit: "Ant King (Savage)", img: "images/units/AntKingSavage.png", isCalculated: true }
...
const unitDatabase = [
...

   {
    ...
    etherealization: [
        " +10 Stat Points each",
        " Paralyzing Venom: Radiation Damage increased to 80% and Slow increased to 20%",
         "+10 Stat Points each",
        " When Monarch's Devotion triggers, all units in range gain +10% Damage",
         "+10 Stat Points each",
